...
import { MixReadInput } from "../enja/MixReadInput";
import { MixReadOutput } from "../enja/MixReadOutput";
...
当然 / はい / その通り
意音文字である漢字は複雑な文字システムであり、情報エントロピーが高いです。/ 形声文字である漢字は複雑な記号システムとして情報量が多いです。/ 意味を表す漢字は、複雑な表記体系であり、情報のエントロピーが高いです。
